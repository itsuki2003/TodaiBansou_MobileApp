  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50">
      ...
      <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        {/* ヘッダー */}
        <div className="mb-8">
          <div className="relative overflow-hidden bg-gradient-to-r from-primary-600 via-primary-700 to-primary-800 rounded-2xl p-8 text-white shadow-lg">
            {/* 背景装飾 */}
            ...
            <div className="relative flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold mb-2">生徒詳細情報</h1>
                <p className="text-white/90 text-lg">
                  {student.full_name}さんの詳細情報を表示しています
                </p>
              </div>
              <div className="flex space-x-3">
                <Link
                  href="/students"
                  className="px-6 py-3 border-2 border-white/30 rounded-xl text-white bg-white/10 hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-primary-700 transition-all duration-200 backdrop-blur-sm font-medium"
                >
                  一覧に戻る
                </Link>
                <Link
                  href={`/students/${studentId}/edit`}
                  className="px-6 py-3 bg-accent-500 text-gray-900 rounded-xl hover:bg-accent-400 focus:outline-none focus:ring-2 focus:ring-accent-400 focus:ring-offset-2 focus:ring-offset-primary-700 transition-all duration-200 font-medium shadow-lg"
                >
                  編集
                </Link>
              </div>
        ...
        {/* 生徒情報セクション */}
        <div className="bg-white rounded-2xl shadow-lg border border-primary-100 p-8 mb-8 hover:shadow-xl transition-all duration-200">
          <div className="flex items-center space-x-3 mb-6">
            <div className="w-8 h-8 bg-gradient-to-br from-primary-500 to-primary-600 rounded-lg flex items-center justify-center">
              <span className="text-white text-sm font-bold">生</span>
            </div>
            <h2 className="text-xl font-bold text-gray-900">生徒情報</h2>
          </div>
        ...
        {/* 保護者情報セクション */}
        <div className="bg-white rounded-2xl shadow-lg border border-secondary-100 p-8 mb-8 hover:shadow-xl transition-all duration-200">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-gray-900">保護者情報</h2>
          </div>
        ...
        {(student.created_at || student.updated_at) && (
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-all duration-200">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-900">システム情報</h2>
            </div>
