    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8">
          ...
          <PageHeader
            title="講師管理"
            description="講師アカウントの管理と運営"
            icon="👨‍🏫"
            colorTheme="secondary"
            actions={
              <button
                onClick={() => setShowCreateModal(true)}
                className="inline-flex items-center px-6 py-3 bg-white/20 text-white rounded-xl hover:bg-white/30 focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-secondary-700 transition-all duration-200 font-medium backdrop-blur-sm"
              >
                新規講師登録
              </button>
            }
